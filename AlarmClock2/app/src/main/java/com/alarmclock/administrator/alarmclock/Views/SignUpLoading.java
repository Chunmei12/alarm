...
public class SignUpLoading extends View{
    //正常状态
    ...
    public SignUpLoading(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SignUpLoading(Context context, AttributeSet attrs, int defStyleAttr) {
